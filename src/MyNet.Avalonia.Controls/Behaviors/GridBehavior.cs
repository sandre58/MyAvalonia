// -----------------------------------------------------------------------
// <copyright file="GridBehavior.cs" company="Stéphane ANDRE">
...
public static class GridBehavior
{
    ...
    /// <summary>
    /// Provides RowDefinitions Property for attached GridBehavior element.
    /// </summary>
    public static readonly AttachedProperty<RowDefinitions> RowDefinitionsProperty = AvaloniaProperty.RegisterAttached<Grid, RowDefinitions>("RowDefinitions", typeof(GridBehavior));
    ...
    /// <summary>
    /// Provides ColumnDefinitions Property for attached GridBehavior element.
    /// </summary>
    public static readonly AttachedProperty<ColumnDefinitions> ColumnDefinitionsProperty = AvaloniaProperty.RegisterAttached<Grid, ColumnDefinitions>("ColumnDefinitions", typeof(GridBehavior));
