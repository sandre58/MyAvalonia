// -----------------------------------------------------------------------
// <copyright file="ProxyBehavior.cs" company="Stéphane ANDRE">
...
public static class ProxyBehavior
{
    ...
    static ProxyBehavior()
    {
        _ = EnableProperty.Changed.Subscribe(EnableChangedCallback);

        // Default builders
        Builders.Add(new(c => c is TextBox, c => new TextBoxProxy((TextBox)c)));
        Builders.Add(new(c => c is ComboBox, c => new ComboBoxProxy((ComboBox)c)));
        Builders.Add(new(c => c is AutoCompleteBox, c => new AutoCompleteBoxProxy((AutoCompleteBox)c)));
        ...
        Builders.Add(new(c => c is CodeBlock, c => new CodeBlockProxy((CodeBlock)c)));
        Builders.Add(new(c => c is MultiComboBox, c => new MultiComboBoxProxy((MultiComboBox)c)));
        Builders.Add(new(c => c is TagBox, c => new TagBoxProxy((TagBox)c)));
        Builders.Add(new(c => c is ButtonSpinner, c => new ButtonSpinnerProxy((ButtonSpinner)c)));
    }

    public static void RegisterBuilder(Func<Control?, bool> canBuild, Func<Control, IControlProxy> build) => Builders.Add(new(canBuild, build));
    ...
    /// <summary>
    /// Provides Proxy Property for attached ProxyBehavior element.
    /// </summary>
    public static readonly AttachedProperty<IControlProxy?> ProxyProperty = AvaloniaProperty.RegisterAttached<StyledElement, IControlProxy?>("Proxy", typeof(ProxyBehavior));
    ...
    /// <summary>
    /// Provides Enable Property for attached ProxyBehavior element.
    /// </summary>
    public static readonly AttachedProperty<bool> EnableProperty = AvaloniaProperty.RegisterAttached<StyledElement, bool>("Enable", typeof(ProxyBehavior));
    ...
    /// </summary>
    public static readonly AttachedProperty<bool> IsActiveProperty = AvaloniaProperty.RegisterAttached<StyledElement, bool>("IsActive", typeof(ProxyBehavior));
    ...
    /// </summary>
    public static readonly AttachedProperty<bool> IsEmptyProperty = AvaloniaProperty.RegisterAttached<StyledElement, bool>("IsEmpty", typeof(ProxyBehavior), true);
    ...
    /// </summary>
    public static readonly AttachedProperty<bool> IsFocusedProperty = AvaloniaProperty.RegisterAttached<StyledElement, bool>("IsFocused", typeof(ProxyBehavior));
