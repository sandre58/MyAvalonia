...
public class ContentDialog : DialogPanel
{
    ...
    public static readonly StyledProperty<WindowStartupLocation> StartupLocationProperty =
        AvaloniaProperty.Register<ContentDialog, WindowStartupLocation>(nameof(StartupLocation));
    ...
    public static readonly StyledProperty<PixelPoint?> PositionProperty =
        AvaloniaProperty.Register<ContentDialog, PixelPoint?>(nameof(Position));
    ...
    public static readonly StyledProperty<bool> ShowCloseButtonProperty =
        AvaloniaProperty.Register<ContentDialog, bool>(nameof(ShowCloseButton), true);
    ...
    public static readonly StyledProperty<bool> ShowInTaskBarProperty =
        AvaloniaProperty.Register<ContentDialog, bool>(nameof(ShowInTaskBar), true);
    ...
    public static readonly StyledProperty<bool> CanResizeProperty =
        AvaloniaProperty.Register<ContentDialog, bool>(nameof(CanResize));
    ...
    public static readonly StyledProperty<string?> ParentClassesProperty =
        AvaloniaProperty.Register<ContentDialog, string?>(nameof(ParentClasses));
