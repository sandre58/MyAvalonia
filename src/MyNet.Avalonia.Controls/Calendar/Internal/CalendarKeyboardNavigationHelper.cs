...
internal static class CalendarKeyboardNavigationHelper
{
    ...
    private static CalendarNavigationResult ResolveUp(
        ...
        {
            MonthContext => new(CalendarNavigationKind.MoveFocus, focusedDate.AddDays(-DateTimeHelper.DaysPerWeek)),
    ...
    private static CalendarNavigationResult ResolveLeft(
        ...
        displayContext switch
        {
            MonthContext => new(CalendarNavigationKind.MoveFocus, focusedDate.AddDays(-1)),
    ...
    private static CalendarNavigationResult ResolveHome(
        ...
        displayContext switch
        {
            MonthContext => new(CalendarNavigationKind.MoveFocus, focusedDate.BeginningOfMonth()),
    ...
    private static CalendarNavigationResult ResolveEnd(
        ...
        displayContext switch
        {
            MonthContext => new(CalendarNavigationKind.MoveFocus, focusedDate.EndOfMonth()),
    ...
    private static CalendarNavigationResult ResolvePageDown(
        ...
        => !ctrl && !shift
            ...
            : displayContext switch
            {
                ...
                MonthContext when shift => new(CalendarNavigationKind.MoveFocus, focusedDate.AddMonths(1)),
