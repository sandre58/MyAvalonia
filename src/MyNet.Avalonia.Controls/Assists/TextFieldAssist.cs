...
public static class TextFieldAssist
{
    ...
    /// <summary>
    /// Provides UpdateValueOnMouseWheel Property for attached TextFieldAssist element.
    /// </summary>
    public static readonly AttachedProperty<bool> UpdateValueOnMouseWheelProperty = AvaloniaProperty.RegisterAttached<StyledElement, bool>("UpdateValueOnMouseWheel", typeof(TextFieldAssist));
    ...
    /// Provides UpdateValueOnMouseWheel Property for attached TextFieldAssist element.
    /// </summary>
    public static readonly AttachedProperty<bool> UpdateValueOnKeyboardProperty = AvaloniaProperty.RegisterAttached<StyledElement, bool>("UpdateValueOnKeyboard", typeof(TextFieldAssist));
