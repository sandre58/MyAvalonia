...
// <copyright file="DateRangePickerEx.Keyboard.cs" company="Stéphane ANDRE">
...
public partial class DateRangePickerEx

{
...

    {
        ...
        if (IsDropDownOpen && Previewer is { } calendar && TextBox is { } textBox)
...

    {
        ...
        if (IsDropDownOpen && Previewer is { } calendar && CalendarFocusHelper.TryHandlePreviewerTab(calendar, TextBox, e))
