...

{
    ...
    public static readonly StyledProperty<TimeRangeInvalidBehavior> InvalidRangeBehaviorProperty =
        ...
        AvaloniaProperty.Register<TimeRangeView, TimeRangeInvalidBehavior>(nameof(InvalidRangeBehavior), TimeRangeInvalidBehavior.Swap);
...

    {
        ...
        if (_startTime is not { } start || _endTime is not { } end)
            ...
            return new(null, IsValid: false, ShouldReportError: false);



        return TimeRangeHelper.BuildPeriod(start, end, ReferenceDate, AllowOvernight, InvalidRangeBehavior);
