...
public class NavigationMenu : ItemsControl
{
    ...
    public static readonly StyledProperty<BindingBase?> IconProperty =
        AvaloniaProperty.Register<NavigationMenu, BindingBase?>(
            nameof(Icon));
    ...
    public static readonly StyledProperty<BindingBase?> SubMenuProperty =
        AvaloniaProperty.Register<NavigationMenu, BindingBase?>(
            nameof(SubMenu));

    public static readonly StyledProperty<BindingBase?> CommandProperty =
        AvaloniaProperty.Register<NavigationMenu, BindingBase?>(
            nameof(Command));
