// -----------------------------------------------------------------------
// <copyright file="ThemeVariantColors.cs" company="Stéphane ANDRE">
...
/// </summary>
public class ThemeVariantColors(ThemeVariant variant) : ObservableObject
{
    /// <summary>
    ...
    /// </summary>
    public required ThemePalette Base { get; set; }
