...
/// <summary>
/// Enumerates all available icon data identifiers for use in the theming system.
/// Each value represents a unique icon that can be referenced and rendered in the UI.
/// </summary>
