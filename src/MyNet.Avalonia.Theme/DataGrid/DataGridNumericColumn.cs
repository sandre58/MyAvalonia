...
public class DataGridNumericColumn : DataGridBoundColumn<NumericUpDown, TextBlock>
{
    ...
    /// </summary>
    public static readonly StyledProperty<SpinnerLayout> LayoutProperty = AvaloniaProperty.Register<DataGridNumericColumn, SpinnerLayout>(nameof(Layout));
    ...
    /// </summary>
    public static readonly StyledProperty<object> DecreaseContentProperty = AvaloniaProperty.Register<DataGridNumericColumn, object>(nameof(DecreaseContent));
    ...
    /// </summary>
    public static readonly StyledProperty<object> IncreaseContentProperty = AvaloniaProperty.Register<DataGridNumericColumn, object>(nameof(IncreaseContent));
