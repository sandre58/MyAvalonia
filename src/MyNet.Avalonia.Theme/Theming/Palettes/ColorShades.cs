...
/// <summary>
/// Represents a color palette with automatically generated shades from lightest to darkest.
/// Provides access to material design style shades, common aliases, and foreground color for easy usage in theming.
/// </summary>
public class ColorShades
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ColorShades"/> class with a base color and an optional foreground color.
    /// Shades are generated automatically from the base color using HSL transformations.
    /// </summary>
    ...
    public ColorShades(Color baseColor, Color? foregroundColor = null)
    {
        Base = baseColor;
