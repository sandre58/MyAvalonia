...
public class OpacityLevels
{
    ...
    public Dictionary<string, object> ToResourceDictionary(string prefix = nameof(ThemeVariantPalette.Opacity))
        => new()
        {
    ...
    public static OpacityLevels FromResourceDictionary(IReadOnlyDictionary<string, object> dictionary, string prefix = nameof(ThemeVariantPalette.Opacity)) => new()
    {
