...
public static class ThemeResources
{
    ...
    [SuppressMessage("Design", "CA1034:Nested types should not be visible", Justification = "It simplifies access to animation-related resources.")]
    public static class Animation
    {
        ...
        public static Token<TimeSpan> Opacity { get; } = new(ThemeResourceKeyFactory.Animation(nameof(Opacity)));
    }
    ...
    public static class Shadow
    {
        ...
        public static Token<ShadowDepth> Control { get; } = new(ThemeResourceKeyFactory.Shadow(nameof(Control)));
        ...
        /// consistent visual theming across the application's user interface.</remarks>
        public static Token<ShadowDepth> Surface { get; } = new(ThemeResourceKeyFactory.Shadow(nameof(Surface)));
    }
    ...
    public static class Corners
    {
        ...
        /// consistent visual theming across the application's user interface.</remarks>
        public static Token<CornerRadius> Control { get; } = new(ThemeResourceKeyFactory.Corners(nameof(Control)));
        ...
        /// consistent visual theming across the application's user interface.</remarks>
        public static Token<CornerRadius> Surface { get; } = new(ThemeResourceKeyFactory.Corners(nameof(Surface)));
    ...
    public static class Font
    {
        ...
        public static class Weight
        {
            ...
            /// </summary>
            public static Token<FontWeight> Header { get; } = new(ThemeResourceKeyFactory.FontWeight(nameof(Header)));
        }
    }
    ...
    [SuppressMessage("Design", "CA1034:Nested types should not be visible", Justification = "It simplifies access to theme-related resources.")]
