...
public sealed class RadialGradientConverter : IValueConverter, IMultiValueConverter
{
    ...
    /// <summary>
    /// Converts a value to a radial gradient brush based on the specified parameters.
    /// </summary>
    ...
    /// <returns>The resolved <see cref="RadialGradientBrush"/> or <see cref="AvaloniaProperty.UnsetValue"/> if conversion fails.</returns>
    ...
    /// <summary>
    /// Converts multiple values to a radial gradient brush based on the specified parameters.
    /// </summary>
