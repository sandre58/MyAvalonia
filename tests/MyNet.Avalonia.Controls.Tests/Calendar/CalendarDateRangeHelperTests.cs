...
public class CalendarDateRangeHelperTests
{
    ...
    public void GetSelectedMin_ReturnsEarliestDate()
    {
        ...
        CalendarDateRangeHelper.GetSelectedMin(dates).Should().Be(new DateTime(2026, 1, 5));
    }
    ...
    public void ClampToRange_ClampsOutsideBounds()
    {
        ...
        CalendarDateRangeHelper.ClampToRange(new DateTime(2026, 1, 1), start, end).Should().Be(start);
        CalendarDateRangeHelper.ClampToRange(new DateTime(2026, 3, 1), start, end).Should().Be(end);
        CalendarDateRangeHelper.ClampToRange(new DateTime(2026, 2, 15), start, end).Should().Be(new DateTime(2026, 2, 15));
    }
