...
public class CalendarBlackoutDatesHelperTests
{
    ...
    public void NormalizeRange_OrdersAscending()
    {
        var (start, end) = CalendarBlackoutDatesHelper.NormalizeRange(
            new DateTime(2026, 5, 20, 14, 30, 0),
            new DateTime(2026, 5, 10, 8, 0, 0));

        start.Should().Be(new DateTime(2026, 5, 10));
        end.Should().Be(new DateTime(2026, 5, 20));
    }
    ...
    {
        var (start, end) = CalendarBlackoutDatesHelper.NormalizeRange(
            new DateTime(2026, 1, 1, 23, 59, 59),
            new DateTime(2026, 1, 2, 0, 0, 1));

        start.Should().Be(new DateTime(2026, 1, 1));
        end.Should().Be(new DateTime(2026, 1, 2));
    }
}
