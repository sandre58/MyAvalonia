...
public class CalendarValidationHelperTests
{
    ...
    public void IsValidFirstDayOfWeek_ValidatesEnumValues(DayOfWeek day, bool expected) => CalendarValidationHelper.IsValidFirstDayOfWeek(day).Should().Be(expected);
    ...
    public void IsValidSelectionMode_ValidatesEnumValues(CalendarSelectionMode mode, bool expected) => CalendarValidationHelper.IsValidSelectionMode(mode).Should().Be(expected);
    ...
    public void IsValidSelection_RejectsDatesOutsideRange()
    {
        ...
        CalendarValidationHelper.IsValidSelection(new(2026, 6, 1), start, end, _ => false).Should().BeFalse();
        CalendarValidationHelper.IsValidSelection(new(2026, 5, 15), start, end, _ => false).Should().BeTrue();
    }
}
