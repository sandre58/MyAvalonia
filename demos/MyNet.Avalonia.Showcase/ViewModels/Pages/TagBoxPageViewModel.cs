...
internal sealed class TagBoxPageViewModel(ICommandFactory commands) : ShowcaseViewModel(nameof(TagBox), commands, [
    new ControlThemeBuilder()
        ...
        .AddProperty(TagBox.SeparatorProperty, string.Empty, x => x.DisplayName(new LocalizedString(nameof(SettingsResources.Separator), filename: nameof(SettingsResources))).Of<TextBoxEditor>(y => y.WithValue(",")))
