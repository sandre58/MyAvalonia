...
internal class ChoiceViewModel<T>(T? value, IProvideValue<string> displayNameFunc, object? icon = null) : ObservableObject, IChoiceViewModel
{
    /// <summary>
