...
internal sealed class ClassChoiceViewModel(CssClass @class, IProvideValue<string> displayName, object? icon = null) : ChoiceViewModel<CssClass>(@class, displayName, icon);
