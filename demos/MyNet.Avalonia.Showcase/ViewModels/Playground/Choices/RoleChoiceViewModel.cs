...
internal sealed class RoleChoiceViewModel(ThemeRole role, IProvideValue<string> displayNameFunc) : ChoiceViewModel<ThemeRole>(role, displayNameFunc);
