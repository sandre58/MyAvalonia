// -----------------------------------------------------------------------
// <copyright file="SliderEditor.cs" company="Stéphane ANDRE">
...
/// </summary>
internal sealed class SliderEditor : IEditorBuilder
{
    ...
    public SliderEditor WithMinimum(decimal minimum)
    {
        _minimum = minimum;
        return this;
    }
    ...
    /// <returns>The current instance of the <see cref="SliderEditor"/>, enabling method chaining.</returns>
    public SliderEditor WithMaximum(decimal maximum)
    {
        _maximum = maximum;
        return this;
    }
    ...
    public SliderEditor WithRange(decimal minimum, decimal maximum)
    {
        _minimum = minimum;
        _maximum = maximum;
        return this;
    ...
    /// <returns>The current instance of the <see cref="SliderEditor"/>, enabling method chaining.</returns>
    public SliderEditor WithIncrement(decimal increment)
    {
    ...
    public IEditorMetadata Build() => new SliderEditorMetadata(_minimum, _maximum, _increment);
}
...
/// <param name="Maximum">The maximum value for the slider editor.</param>
/// <param name="Increment">The increment value for the slider editor.</param>
internal sealed record SliderEditorMetadata(decimal Minimum, decimal Maximum, decimal Increment) : IEditorMetadata;
