...
internal sealed record OptionMetadata(IObservableValue<string> DisplayName, MaterialIconKind? Icon, IEditorMetadata? Metadata, string? Group = null);
...
/// <param name="Icon">An optional icon associated with the option, which can be used for visual representation in the user interface.</param>
/// <param name="Metadata">The editor metadata associated with the option.</param>
internal sealed record OptionMetadata<TEditor>(IObservableValue<string> DisplayName, MaterialIconKind? Icon, TEditor Metadata)
