...
internal sealed partial class SelectableTextBlocksPage : AutoBuildPage
{
    ...
    {
        var item = new SelectableTextBlock { HorizontalAlignment = global::Avalonia.Layout.HorizontalAlignment.Center, Text = data.Role.ToString().Or(data.Size.OrEmpty()).Or("Default") };
